...
import { updateVoucher } from "../../../redux/slice/voucherSlice";

const { RangePicker } = DatePicker;

const VoucherFormUpdate = () => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(updateVoucher({ ...payload, id: voucherData._id }))
      .unwrap()
      .then(() => {
...
export default VoucherFormUpdate;
